...
use_rag = st.toggle("Enable RAG (Retrieval-Augmented Generation)", value=True, help="Use RAG to enhance the model's responses with relevant background knowledge.")
